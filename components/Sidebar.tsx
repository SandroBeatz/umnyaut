...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="fixed left-4 top-4 bottom-4 w-20 z-50 flex flex-col gap-4">
      {/* Logo Section */}
      <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg border border-orange-100/50 p-4">
        <button
          onClick={onLogoClick}
      ...
      {/* Menu Section */}
      <nav className="flex-1 bg-white/70 backdrop-blur-md rounded-2xl shadow-lg border border-orange-100/50 p-3 flex flex-col items-center justify-center gap-3">
        {menuItems.map((item) => {
      ...
      {/* Account Section */}
      <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg border border-orange-100/50 p-4 relative">
        <button
